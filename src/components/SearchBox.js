...
const SearchBox = ({searchChange, category, keyPress} )=> {
  return(
    <div id="searchbox" className="relative pa0 fr">
      ...
      <input className="tc white bg-transparent br2 bw1 b--solid custom--b--secondary border-box" type="search" placeholder={`Filter by ${category}`} onChange={searchChange} onKeyPress={keyPress}/>
    </div>
  );
}
