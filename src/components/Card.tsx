    ...
    title="email"
                    ...
                    {links.website === '' ? (
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                        >   <span className="sr-only">Visit {name}'s website</span>
                            <svg className="w2 h2" aria-hidden="true" viewBox="0 0 24 24">
                    ...
                    {links.github === '' ? (
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                        >   <span className="sr-only">Visit {name}'s GitHub profile</span>
                           <svg className="w2 h2" aria-hidden="true" viewBox="0 0 24 24">
                    ...
                    {links.linkedin === '' ? (
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                        >   <span className="sr-only">Visit {name}'s LinkedIn profile</span>
                            <svg className="w2 h2" aria-hidden="true" viewBox="0 0 24 24">
